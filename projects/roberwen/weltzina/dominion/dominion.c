...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case mine:
      playMine(choice1, choice2, handPos, currentPlayer, state);
      return 0;
    ...
    case tribute:
      playTribute(currentPlayer, nextPlayer, state);
      return 0;

    case ambassador:
      //calls separate ambassador card effect method
      playAmbassador(choice1, choice2, handPos, currentPlayer, state);
      return 0;
