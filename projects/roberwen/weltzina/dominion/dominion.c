...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case baron:
            return baronEffect(choice1, state, handPos, currentPlayer);
    ...
    case tribute:
      return tributeEffect(state, handPos, nextPlayer, tributeRevealedCards, currentPlayer);
...
//end of original dominion.c

//Added for assignment 2
//Bug 1: Do not set card_not_discarded.
//Bug 2: Increment rather than decrement estates.
int baronEffect(int choice1, struct gameState *state, int handPos, int currentPlayer)
{
    ...
    if (choice1 > 0){//Boolean true or going to discard an estate
        ...
        while(!card_not_discarded){
            if (state->hand[currentPlayer][p] == estate){//Found an estate card!
                ...
                card_not_discarded = 1;//Exit the loop (BUG: will work)
            }
        ...
        if (supplyCount(estate, state) > 0){
            ...
            state->supplyCount[estate]--;//BUG increment Estates
            if (supplyCount(estate, state) == 0){
                isGameOver(state);
            }
...
//Added for assignment 2
//BUG1: choice 1 = choice 2
//BUG2: handPos off by one.
...
//Added for assignment 2
//BUG 1 and 2: Return 0 for two -1 outcomes.
...
//Added for Assignment 2
//Bug 1: set i equal to 3 to end the second for loop early.
//Bug 2: set nextPlayer = currentPlayer
int tributeEffect(struct gameState *state, int handPos, int nextPlayer, int tributeRevealedCards[], int currentPlayer)
{
...
//Added for assignment 2
//Bug 1: setting j to i in for loop.
//Bug 2: return 0 instead of -1  for copper < or > gold.
