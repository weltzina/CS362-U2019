...
int main() {
  ...
  assertTrue(testG.deckCount[thisPlayer], 0);
  printf("discardCount = %d, expected = %d\n", testG.discardCount[thisPlayer], 5);
  assertTrue(testG.discardCount[thisPlayer], 5);
  ...
  printf("hand count = %d, expected = %d\n", testG.handCount[thisPlayer+1], 0);
  assertTrue(testG.handCount[thisPlayer+1], 0);
  printf("discard count = %d, expected = %d\n", testG.discardCount[thisPlayer+1], 5);
  assertTrue(testG.discardCount[thisPlayer+1], 5);
  printf("\n");
